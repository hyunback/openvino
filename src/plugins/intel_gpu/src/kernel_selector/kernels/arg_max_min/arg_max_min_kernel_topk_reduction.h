...
class ArgMaxMinKernelTopKReduction : public ArgMaxMinKernelBase {
public:
    ArgMaxMinKernelTopKReduction() : ArgMaxMinKernelBase("arg_max_min_topk_reduction") {}
    virtual ~ArgMaxMinKernelTopKReduction() {}
