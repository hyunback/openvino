...
class ArgMaxMinKernelTopKSubgroup : public ArgMaxMinKernelBase {
public:
    ArgMaxMinKernelTopKSubgroup() : ArgMaxMinKernelBase("arg_max_min_topk_subgroup") {}
    virtual ~ArgMaxMinKernelTopKSubgroup() {}
