...
KernelsData FeedForwardKernelRef::GetKernelsData(const Params& params) const {
    ...
    GPU_DEBUG_INFO << dispatchData.gws[0] << ", " << dispatchData.gws[1] << ", " << dispatchData.gws[2] << std::endl;
    GPU_DEBUG_INFO << dispatchData.lws[0] << ", " << dispatchData.lws[1] << ", " << dispatchData.lws[2] << std::endl;
