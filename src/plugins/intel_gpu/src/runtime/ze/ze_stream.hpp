...
public:
    ...
    bool uses_regular_command_queue() const { return m_use_regular_cmd_queue; }
    ...
    ze_stream(ze_stream&& other)
        ...
        , m_use_regular_cmd_queue(other.m_use_regular_cmd_queue)
        , m_command_queue(other.m_command_queue)
        , m_onednn_command_queue(other.m_onednn_command_queue)
        , m_command_list(other.m_command_list)
        , m_onednn_command_list(other.m_onednn_command_list)
        ...
        , m_user_ev_factory(std::move(other.m_user_ev_factory)) {
            ...
            other.m_onednn_command_queue = nullptr;
            other.m_onednn_command_list = nullptr;
            other.m_use_regular_cmd_queue = false;
        }
    ...
    void wait() override;
    void mark_onednn_pending() const override;
    void ensure_cmd_list_ready() const override;
...
private:
    ...
    bool m_use_regular_cmd_queue = false;
    mutable ze_command_queue_handle_t m_command_queue = nullptr;
    mutable ze_command_queue_handle_t m_onednn_command_queue = nullptr;
    mutable ze_command_list_handle_t m_command_list = 0;
    mutable ze_command_list_handle_t m_onednn_command_list = 0;
    mutable bool m_regular_has_pending_cmds = false;
    mutable bool m_regular_list_is_closed = false;
    mutable bool m_regular_has_submitted = false;
